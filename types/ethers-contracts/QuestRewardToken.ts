...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface QuestRewardTokenInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
  ...
  export interface QuestRewardToken extends BaseContract {
    
    connect(runner?: ContractRunner | null): QuestRewardToken;
    waitForDeployment(): Promise<this>;

    interface: QuestRewardTokenInterface;
